            ...
            <div className="container mx-auto px-6">
                ...
                >
                    ...
                    <div className="max-w-md mx-auto relative group">
                        <div className="absolute inset-0 bg-gradient-to-r from-[var(--color-secondary)]/20 to-purple-500/20 rounded-full blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                        <div className="relative flex items-center bg-white/5 border border-white/10 rounded-full px-4 py-3 focus-within:border-[var(--color-secondary)]/50 focus-within:bg-white/10 transition-all">
                            ...
                            <input
                                ...
                                className="bg-transparent border-none text-white placeholder:text-white/30 focus:outline-none w-full"
                            />
                            {searchQuery && (
                ...
                >
                    {categories.map((cat) => (
                        <button
                            ...
                            className={`px-5 py-2 rounded-full text-xs uppercase tracking-widest font-bold transition-all border ${cat === selectedCategory
                                ? 'bg-[var(--color-secondary)] text-[var(--color-primary)] border-[var(--color-secondary)]'
                                : 'bg-white/5 text-[var(--color-text-muted)] border-white/5 hover:border-[var(--color-secondary)]/40 hover:text-white'
                                }`}
                        >
                            {cat}
                        </button>
