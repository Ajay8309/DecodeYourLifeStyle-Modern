    ...
    useEffect(() => {
        const fetchPostData = async () => {
            ...
            try {
                ...
                const allPostsRes = await axios.get('http://localhost:5001/api/posts');
    ...
    return (
        <div className="min-h-screen bg-[var(--color-primary)] pt-32 pb-20">
            ...
            <article className="container mx-auto px-6 max-w-4xl">
                {/* Back Link */}
                <Link to="/blog" className="inline-flex items-center gap-2 text-[var(--color-text-muted)] hover:text-[var(--color-secondary)] transition-colors mb-8">
                ...
                <motion.div
                    ...
                    className="mb-12"
                >
                    <span className="text-sm uppercase tracking-[0.2em] text-[var(--color-secondary)] font-bold mb-4 block">
                        {post.category}
                    </span>
                    ...
                    <div className="flex flex-wrap items-center gap-6 text-sm text-[var(--color-text-muted)] border-b border-white/10 pb-8">
