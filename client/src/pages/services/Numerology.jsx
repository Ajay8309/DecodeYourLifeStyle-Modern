                ...
                <div className="grid lg:grid-cols-3 gap-12">
                    ...
                    >
                        ...
                        <div className="glass rounded-[2rem] p-8 md:p-10 border border-white/5 relative overflow-hidden group">
                            ...
                            <h2 className="text-3xl font-serif font-bold mb-6 relative z-10">The Vibration of Numbers</h2>
                            <div className="space-y-6 text-[var(--color-text-muted)] leading-relaxed relative z-10 text-lg">
                                <p>
                                    The universe is built on mathematics. Pythagoras believed that "all is number," and Vedic Numerology (Sankhya Sastra) takes this further by linking numbers to planetary energies.
                                </p>
                                <p>
                                    Your birth date and name are not random. They carry a specific vibrational frequency that dictates your personality, hidden talents, strengths, and life challenges. By analyzing these numbers, we can uncover the blueprint of your destiny and align you with your natural flow.
                                </p>
                            </div>
                        </div>
                        ...
                        <div>
                            <h3 className="text-2xl font-serif font-bold mb-8 flex items-center gap-3">
                                <Sparkles className="text-sky-400" /> What We Uncover
                            </h3>
                    ...
                    <div className="lg:col-span-1">
                        ...
                        >
                            <div className="glass p-8 rounded-[2rem] border border-sky-500/30 shadow-[0_0_30px_rgba(14,165,233,0.1)] relative overflow-hidden">
                                ...
                                <p className="text-sky-200 text-sm mb-8">Calculate your path to success.</p>
