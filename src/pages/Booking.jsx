...
const pricingData = [
    { service: 'Reiki Healing', price: '₹1,200', duration: '30 mins' },
    { service: 'Tarot Reading', price: '₹2,000', duration: '30–40 mins' },
    { service: 'Astrology / Numerology', price: '₹3,500', duration: '1 hour' },
    { service: 'Akashic Records', price: '₹4,500', duration: '1 hour' },
    { service: 'Integrated Session', price: '₹7,000', duration: '90 mins' },
    { service: 'House Vastu', price: '₹10,000+', duration: 'On-site' },
];
            ...
            <div className="container mx-auto px-6">
                ...
                <section className="max-w-3xl mx-auto mb-24">
                    ...
                    <div className="glass rounded-2xl overflow-hidden">
                        {/* Header Row */}
                        <div className="grid grid-cols-3 px-6 py-4 border-b border-white/10 text-sm uppercase tracking-widest text-[var(--color-secondary)]">
                            <span>Service</span>
                        ...
                        {pricingData.map((item, i) => (
                            <motion.div
                                ...
                                className={`grid grid-cols-3 px-6 py-5 border-b border-white/5 cursor-pointer transition-all duration-300 hover:bg-white/5 ${selectedService?.service === item.service ? 'bg-[var(--color-secondary)]/10 border-l-4 border-l-[var(--color-secondary)]' : ''
                                    }`}
                            >
                            ...
                            <AnimatePresence mode="wait">
                                ...
                                {currentStep === 0 && (
                                    <motion.div key="s1" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="text-center">
                                        ...
                                        <div className="w-48 h-48 bg-white rounded-xl mx-auto flex items-center justify-center text-gray-400 text-xs">
                                            QR Code Placeholder
                                        </div>
                                    </motion.div>
                                )}
                                ...
                                {currentStep === 2 && (
                                    <motion.div key="s3" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="text-center">
                                        ...
                                        <p className="text-[var(--color-text-muted)] mb-8">Choose a time that works for you via Calendly integration.</p>
                                        <div className="glass rounded-xl p-12 border border-white/10 text-[var(--color-text-muted)]">
