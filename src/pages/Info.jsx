        ...
        <div className="min-h-screen bg-[var(--color-primary)] pt-32 pb-20">
            <div className="container mx-auto px-6">
                <motion.h1
                    ...
                    className="text-5xl md:text-7xl font-serif font-bold mb-20 text-center"
                >
                    Client <span className="text-[var(--color-secondary)]">Information</span>
                </motion.h1>
                ...
                <section className="mb-24 max-w-3xl mx-auto">
                    ...
                    <div className="relative mb-8">
                        ...
                        <input
                            ...
                            className="w-full bg-white/5 border border-white/10 rounded-xl py-3 pl-12 pr-4 focus:outline-none focus:border-[var(--color-secondary)] transition-colors text-[var(--color-text)] placeholder:text-white/30"
                        />
                    </div>
                    ...
                    <div className="space-y-3">
                        {filteredFaqs.map((faq, index) => (
                            <div key={index} className="glass rounded-xl overflow-hidden">
                                <button
                                    ...
                                    className="w-full text-left px-6 py-5 flex justify-between items-center hover:bg-white/5 transition-colors gap-4"
                                >
                                ...
                                <AnimatePresence>
                                    {openFaq === index && (
                                        ...
                                        >
                                            <div className="px-6 pb-5 text-[var(--color-text-muted)] border-t border-white/5 pt-4 text-sm leading-relaxed">
                                                {faq.a}
                                            </div>
                                        </motion.div>
                                    )}
                        ...
                        {filteredFaqs.length === 0 && (
                            <p className="text-center text-[var(--color-text-muted)] py-8">No questions match your search.</p>
                        )}
                    </div>
                </section>
