            ...
            >
                <div className="max-w-[1400px] mx-auto px-6">
                    ...
                    <div className="hidden md:grid grid-cols-[1fr_auto_1fr] items-center gap-6">
                        ...
                        {/* Center Logo */}
                        <Link to="/" className="text-xl font-serif font-bold tracking-[0.15em] whitespace-nowrap text-center">
                    ...
                    <div className="flex md:hidden justify-between items-center">
                        ...
                        <Link to="/" className="text-lg font-serif font-bold tracking-[0.12em]">
                            DECODE <span className="text-[var(--color-secondary)]">YOUR LIFE</span>
                        </Link>
