...
const Services = () => {
    ...
    return (
        <div ref={scrollRef} className="min-h-screen bg-[#0f1410] overflow-x-hidden relative">
            ...
            <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
                ...
                {/* Gradient Overlays */}
                <div className="absolute inset-0 bg-gradient-to-b from-[#0f1410]/40 via-transparent to-[#0f1410] z-0" />
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_0%,#0f1410_90%)] z-0" />
                ...
                >
                    ...
                    <motion.h1
                        ...
                        className="text-5xl md:text-6xl lg:text-7xl font-light text-white mb-8 tracking-tight leading-[1.1]"
                        style={{ fontFamily: "'Cormorant Garamond', serif" }}
                    >
                        Holistic <br />
                        <span className="text-emerald-400 italic">Services</span>
                    </motion.h1>
                    ...
                    >
                        <button
                            ...
                            className="group relative px-10 py-4 bg-emerald-600 hover:bg-emerald-500 text-white rounded-sm transition-all duration-300 flex items-center gap-2 shadow-lg shadow-emerald-900/50 mx-auto"
                        >
                            <span className="text-sm font-medium tracking-wide">Explore All Sessions</span>
