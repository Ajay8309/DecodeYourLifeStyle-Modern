                        ...
                        >
                            ...
                            <div className="space-y-6 mb-8">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xs text-[var(--color-secondary)] mt-1">Starts from INR 14,000</div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4">
                                    <div className="w-10 h-10 rounded-full bg-[var(--color-secondary)] text-[var(--color-primary)] flex items-center justify-center">
                            ...
                            <Link to="/booking">
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.95 }}
                                    className="w-full bg-[var(--color-secondary)] text-[var(--color-primary)] py-4 font-bold rounded-xl mb-4 shadow-lg hover:shadow-[0_0_20px_rgba(212,175,55,0.4)] transition-all"
                                >
