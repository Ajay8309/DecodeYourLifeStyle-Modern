                ...
                <div className="grid lg:grid-cols-3 gap-12">
                    ...
                    >
                        ...
                        <div className="glass rounded-[2rem] p-8 md:p-10 border border-white/5 relative overflow-hidden group">
                            ...
                            <h2 className="text-3xl font-serif font-bold mb-6 relative z-10">Map of the Soul</h2>
                            <div className="space-y-6 text-[var(--color-text-muted)] leading-relaxed relative z-10 text-lg">
                                <p>
                                    Your birth chart is a snapshot of the cosmos at the exact moment you took your first breath. It is not just a prediction tool, but a map of your karma, strengths, challenges, and highest potential.
                                </p>
                                <p>
                                    In Vedic Astrology (Jyotish), we view you as a soul on a journey. By understanding your planetary placements, dashes (timings), and transits, you stop fighting against the current and start navigating your life with precision and grace.
                                </p>
                            </div>
                        </div>
                        ...
                        <div>
                            <h3 className="text-2xl font-serif font-bold mb-8 flex items-center gap-3">
                                <Sparkles className="text-amber-400" /> What We Uncover
                            </h3>
                            <div className="grid md:grid-cols-2 gap-4">
                                {[
                                    ...
                                    >
                                        ...
                                        <span className="text-amber-100 font-medium">{item.text}</span>
                                    </motion.div>
                                ))}
                            </div>
                        </div>
                    ...
                    <div className="lg:col-span-1">
                        ...
                        >
                            <div className="glass p-8 rounded-[2rem] border border-amber-500/30 shadow-[0_0_30px_rgba(245,158,11,0.1)] relative overflow-hidden">
                                ...
                                <p className="text-amber-200 text-sm mb-8">Navigate your life with cosmic wisdom.</p>
